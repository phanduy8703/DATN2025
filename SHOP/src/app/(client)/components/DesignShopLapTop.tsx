        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
              Cảm ơn bạn đã quan tâm đến shop của chúng tôi! Chúng tôi
              luôn mong muốn mang đến cho bạn những sản phẩm chất lượng nhất.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-10">
              Với thiết kế độc đáo và chất lượng cao cấp, HaUI SHOP sẽ giúp bạn
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="p-6">
                  ...
                  <p className="text-gray-200 text-sm mt-2">
                    Khám phá xu hướng sản phẩm 2025
                  </p>
                </div>
              </div>
            </div>
