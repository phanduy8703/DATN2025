    ...
    <div className="border rounded-lg p-4 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-semibold text-gray-800 mb-2 text-black">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <h3 className="font-medium text-gray-900 mb-2 text-black">Tiến trình xử lý</h3>
        <div className="flex justify-between">
          ...
          >
            ...
            <p className="mt-1 text-xs text-black">Chờ xử lý</p>
          </div>
          ...
          >
            ...
            <p className="mt-1 text-xs text-black">Đã phê duyệt</p>
          </div>
          ...
          >
            ...
            <p className="mt-1 text-xs text-black">Đã hoàn trả</p>
          </div>
          ...
          >
            ...
            <p className="mt-1 text-xs text-black">Đã từ chối</p>
          </div>
        </div>
      </div>
