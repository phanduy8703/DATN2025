    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text>Cảm ơn quý khách đã mua hàng tại HaUI SHOP!</Text>
          <Text>Hóa đơn điện tử này có giá trị như hóa đơn tài chính.</Text>
          <View style={styles.footerContact}>
            <Text style={styles.contactItem}>Hotline: 1900 1234</Text>
            <Text style={styles.contactItem}>Email: support@haui.shop</Text>
            <Text style={styles.contactItem}>Website: www.haui.shop</Text>
          </View>
        </View>
      </Page>
    </Document>
...
const ExportInvoice = ({ order }: { order: OrderManage }) => {
  ...
  return (
    <PDFDownloadLink
      ...
      fileName={`HAUI_HD${order.order_id || "000001"}_${orderDate}.pdf`}
