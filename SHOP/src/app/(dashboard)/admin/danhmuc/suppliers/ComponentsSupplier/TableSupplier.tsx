    ...
    <div className="overflow-x-auto">
      <Table className="table table-zebra text-sm">
        ...
        {supplier.length > 0 ? (
            ...
            {supplierList.map((supplier) =>
              supplier.ProductSuppliers.map((ps) => (
                <TableRow key={supplier.supplier_id} className="">
                  ...
                  <TableCell className="px-4 py-2 text-black">{ps.quantity}</TableCell>
                  <TableCell className="px-4 py-2 text-black">
                  ...
                  <TableCell className="px-3 py-2 flex space-x-4 text-black">
                    <DeleteSupplier
          ...
          <TableBody>
            <TableRow>
              <TableCell colSpan={10} className="text-center text-black">
