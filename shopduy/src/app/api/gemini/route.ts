...
export async function POST(req: NextRequest) {
  try {
    ...
    let context =
      "Xin chào! Tôi là trợ lý hỗ trợ khách hàng về Công nghệ và quần áo. Nếu bạn cần tư vấn về sản phẩm, size, giá cả hay cách phối đồ, tôi rất sẵn lòng giúp đỡ.";
    ...
    if (checkFuzzyMatch(fuseSize)) context += " Hãy tư vấn chọn size.";
      ...
      context += " Hãy tư vấn về Công nghệ.";
